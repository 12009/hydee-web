        ...
        <li>
            <div class="accountDetailLeft">
                ...
                <div class="reChargeFun">
                    ...
                    <a onclick="loadingPage('/view/accountRecharge');" class="count checkChargeLog">查看充值记录></a>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success  : function(data, textStatus, XMLHttpResponse) {
            if(data.result){
                ...
                $('#yesterdayUserAccount').html(Number(_monthTaskDate[_monthTaskDate.length-1].dayTaskCount));
