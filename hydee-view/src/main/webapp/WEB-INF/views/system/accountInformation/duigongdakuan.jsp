...
<div class="right-main accountRecharge">
    <p class="font-color-crimson ">账户充值方式：对公打款<span style=" float:right;"><a style="color:#c6244b;" onclick="loadingPage('/view/accountRecharge')" class="width100 fakeBtn-hover-crimson">返回账户充值</a></span></p>
...
<script type="text/javascript">
    ...
    function addRecharge() {
        ...
        if (accountName == null || accountName == "") {
            ...
            return;
        } else if (bankCard == null || bankCard == "" || (bankCard.length != 16 && bankCard.length != 19 && bankCard.length != 15)) {
