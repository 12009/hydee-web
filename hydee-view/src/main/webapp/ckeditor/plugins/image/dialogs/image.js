                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        },
                        {
                            ...
                            align: "center",
                            label: d.lang.common.uploadImg,
                            width: '120px',
                            hidden: 0,
                            onLoad: function(){
                                var dialog = this.getDialog(),
                                    uploadBtn = this.domId,
                                    videoUrl = dialog.getContentElement('info', 'txtUrl').domId,
                                    uptokenUrl = "/hydee/qiniu/uptoken",
                                    domain = "http://hydee.xiaomi.hydee.cn/",
                                    uploadBtnDom = $("#" + uploadBtn),
                                    imgUrlDom = $("#" + videoUrl).find("input:eq(0)");
                                var qnImgUploader = Qiniu.uploader({
                                    ...
                                    init: {
                                        'FilesAdded': function(up, files) {
                                            plupload.each(files, function(file) {
                                                var _typeReg = new RegExp("jpg|png|gif|jpeg$");
                                                if( file.type.match(_typeReg) ){
                                                    uploadBtnDom.attr({"disabled":"true"});
                                                    up.start();
                                                }else{
                                                    window.error("抱歉,您选择的文件是不支持的图片格式。");
                                                }
                                            });
                                        },
                                        'UploadProgress': function(up, file) {
                                            ...
                                            uploadBtnDom.html("正在上传("+up.total.percent+"%)");
                                        },
                                        'FileUploaded': function(up, file, info) {
                                            ...
                                            uploadBtnDom.html("上传图片");
                                            imgUrlDom.val(sourceLink);
                                            imgUrlDom.change();
                                        },
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    onShow: function(){
                                        if(this.getValue() == '') this.setValue('100%');
                                    }
                                },
                                {
                                    type: "text",
