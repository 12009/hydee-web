	...
	CKEDITOR.dialog.add( 'videoDialog', function( editor ) {
		var dialogDefinition = {
			...
			onOk: function() {
				...
				var videoWidth = dialog.getValueOf( 'tab-video', 'width' ) || 400;
				var videoHeight = dialog.getValueOf( 'tab-video', 'height' ) || 300;
				var videoHtml  = "<p><video src='"+videoUrl+"' controls='controls' height='"+videoHeight+"px'>";
					videoHtml += "您的浏览器不支持 video 标签。";
					videoHtml += "</video></p>";
