...
public class BankCardBin {
	...
	public final static int[] BANK_BIN = {
            ...
            623251, 628351, 627066,627066,627067,627068,627069,412962,412963,415752,415753,622535,622536,622538,
            622539,622983,998800,623668,621446};
    // "发卡行.卡种名称",
	public static final String[] BANK_NAME = {
            ...
            "玉溪市商业银行·红塔卡" ,"平安银行","平安银行","平安银行","平安银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","光大银行","建设银行","长沙银行"};

    public static String getNameOfBank(String charBin, int offset) {
        int bin = 0, index = 0;
        bin=Integer.valueOf(charBin);
        index=binarySearch(BANK_BIN, bin);
        System.out.println(BANK_BIN.length+";"+BANK_NAME.length);
        if (index == -1 ||  index > BANK_BIN.length) {
            return "没有记录的卡号:\n";
        }
